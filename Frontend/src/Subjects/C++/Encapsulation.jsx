...
<Link to='/cplusplus/files'> <li>Files</li></Link>
      ...
      <div className="min-h-screen bg-gray-100 flex-1 p-6">
        <div className="bg-white shadow-lg rounded-lg max-w-3xl w-full p-8">
          <h1 className="text-4xl font-bold text-blue-600 mb-4">C++ Encapsulation</h1>
          <p className="text-gray-700 text-lg leading-relaxed mb-6">
            Encapsulation is an OOP principle that restricts direct access to some of an object's components and can prevent the accidental modification of data.
          </p>
...
public:
    void setSpeed(int s) { // public method to set the speed
        speed = s;
    }

    int getSpeed() { // public method to get the speed
        return speed;
    }
};
...
int main() {
    Car car;
    car.setSpeed(80);
    cout << "Car speed: " << car.getSpeed() << " km/h" << endl;
    return 0;
}
`}
            </code>
