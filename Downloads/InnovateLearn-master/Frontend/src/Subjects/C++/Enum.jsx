...
<Link to='/cplusplus/files'> <li>Files</li></Link>
      ...
      <div className="min-h-screen bg-gray-100 flex-1 p-6">
        <div className="bg-white shadow-lg rounded-lg max-w-3xl w-full p-8">
          <h1 className="text-4xl font-bold text-blue-600 mb-4">C++ Enum</h1>
          <p className="text-gray-700 text-lg leading-relaxed mb-6">
            An enum (enumeration) is a user-defined data type that consists of integral constants, which makes code more readable and maintainable.
          </p>
...
int main() {
    Day today = Wednesday;
    cout << "Day of the week: " << today << endl;
    return 0;
}
`}
            </code>
