...
export default function Splash() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      router.replace('/test-rides/ongoing');
    }, 2500);
    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Image
          ...
          resizeMode="cover"
        />
        <Text style={styles.title}>TestRide Started</Text>
      </View>
      {/* Moved subtitle outside of content to position it independently at the bottom */}
